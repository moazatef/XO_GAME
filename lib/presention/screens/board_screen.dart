...
class _BoardScreenState extends State<BoardScreen> {
  ...
  void initState() {
    super.initState();
    _xoGameCubit = XoGameCubit(XoGameInitial(), widget.roomId);
      ...
      body:  BlocProvider(
                  ...
                  child: BlocConsumer<XoGameCubit, XoGameState>(
                    ...
                    builder: (context, state) {
                      ...
                      final list =
                          List.generate(rowsLength * columnsLength, (index) {
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return GestureDetector(
                                onTap: () {
                                  ...
                                  final nextPlayerValue =
                                      _xoGameCubit.getCurrentPlayer;
                                  _xoGameCubit.add(
                                    context: context,
                                    indexRow: indexRow,
                                ...
                                child: Container(
                                  decoration: BoxDecoration(
                                    border: Border.all(
                                        color:
                                            const Color.fromARGB(255, 164, 148, 0)),
                                  ),
                                  child: Center(
                                      child: Text(
                                    cellValue == XO.non ? '' : cellValue.name,
                                    style: TextStyle(
                                      color: XO.o == cellValue
                                          ? Colors.blue
                                          : Colors.red,
                                      fontSize: 40.0,
